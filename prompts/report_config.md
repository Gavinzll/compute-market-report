...
国产战略关注卡必须进入国内指数表和国内柱状图：`昇腾 910B`、`寒武纪思元 MLU`、`海光 DCU`、`壁仞`、`摩尔线程`。这些卡即使 Confidence < 70 或仍处于 REVIEW，也不得从国内指数和柱状图中移除。若标准 8卡整机长租价不可得，必须继续扩源到国产智算中心报价、8卡训推一体机租赁、集成商报价、媒体/社区线索和招投标线索；不得把云主机单卡价、单卡月租或未确认卡数的套餐价直接乘以 8 当成 8卡整机月租。低置信参考价必须以 8卡整机为目标口径，优先用同类 8卡整机价或 910B 区间作上锚，标注来源、架构/卡数不确定性、折算方式和 Review 原因，不进入 ROI、历史方向判断或 AI 方向性结论。
