...
国产战略关注例外：`昇腾 910B`、`寒武纪 MLU`、`海光 DCU`、`壁仞`、`摩尔线程` 必须进入国内指数表和国内柱状图。若无法取得标准 8卡整机月租或 Confidence < 70，仍保留在指数和柱状图中并标注 `Strategic Watch / REVIEW`；价格不足时继续扩源到云主机包月价、单卡月租、国产智算中心报价、集成商报价、媒体/社区线索和招投标线索，给出低置信参考价或等效 8卡月租，但不得进入 ROI 或 AI 方向性结论。
