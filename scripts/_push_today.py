...
FILES = [
    ...
    "latest-mobile.html",
    "index.html",
    "reports/2026-09-14.html",
    "reports/2026-09-14-mobile.html",
    "data/history.jsonl",
    "data/price_changes.csv",
    "data/audit_2026-09-14.json",
    "data/cmis_snapshot_2026-09-14.json",
    "data/discovered_benchmark_2026-09-14.json",
    "data/discovered_gpu_2026-09-14.json",
    "data/discovered_token_2026-09-14.json",
    "data/fx_rate_2026-09-14.json",
    "data/gitee_ai_2026-09-14.json",
    "data/rejected_2026-09-14.json",
    "data/shengsuanyun_2026-09-14.json",
    "data/raw/gpurentalprices_2026-09-14.json",
    "data/raw/litellm_2026-09-14.json",
    "data/raw/modelsdev_2026-09-14.json",
    "data/raw/openrouter_2026-09-14.json",
]
...
def main():
    ...
    for path in FILES:
        ...
        sha = remote_sha(path)
        payload = {
            "message": f"chore(data): update {path} for CMIS Daily 2026-09-14",
            "content": content,
            "branch": BRANCH,
        }
        if sha:
