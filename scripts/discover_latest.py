...
_BENCHMARK_FALLBACK: list[dict[str, Any]] = [
    ...
    {"模型": "Claude Fable 5", "厂商": "Anthropic", "AA Intelligence Index": 60, "SciCode 编程能力 (%)": 0, "GDPval-AA v2 Elo": 0, "Output Speed (t/s)": 0, "Cost per Task (USD)": 0.00, "来源": "Artificial Analysis（Intel=60 全球第1；Speed/Cost/Elo 暂无数据）", "更新时间": "2026-07-19"},
