...
def scrape_smm_gpu_prices() -> dict[str, dict[str, Any]]:
    ...
    gpu_search = [
        ...
        ("RTX 5090", [
            ...
            r'5090[^万。；]{0,25}?(?:月租|租赁)[^万。；]{0,12}?(\d+\.?\d*)\s*万\s*[-—~]\s*(\d+\.?\d*)\s*万',
            # 单值：不跨句、限制距离，避免把邻近 GPU（如 Pro 6000）的价格误配给 5090
            r'5090[^万。；]{0,30}?报[^万。；]{0,20}?(\d+\.?\d*)\s*万',
...
_BENCHMARK_FALLBACK: list[dict[str, Any]] = [
    ...
    {"模型": "Command A+", "厂商": "Cohere", "AA Intelligence Index": 37, "SciCode 编程能力 (%)": 0, "GDPval-AA v2 Elo": 0, "Output Speed (t/s)": 281, "Cost per Task (USD)": 0.00, "来源": "Artificial Analysis（Intel=37；Speed=281 tps；Cost/Elo AA 未提供）", "更新时间": "2026-07-19"},
    ...
    {"模型": "Hunyuan-Hy3", "厂商": "腾讯混元", "AA Intelligence Index": 41, "SciCode 编程能力 (%)": 0, "GDPval-AA v2 Elo": 1235, "Output Speed (t/s)": 48, "Cost per Task (USD)": 0.00, "来源": "Artificial Analysis（Intel=41；Elo=1235；Speed=48 tps；Cost AA 未提供）", "更新时间": "2026-07-19"},
    ...
    {"模型": "JT-4.1 Flash", "厂商": "中国移动", "AA Intelligence Index": 39, "SciCode 编程能力 (%)": 0, "GDPval-AA v2 Elo": 0, "Output Speed (t/s)": 0, "Cost per Task (USD)": 0.00, "来源": "Artificial Analysis（Intel=39；Speed/Cost/Elo AA 未提供，无公开 API）", "更新时间": "2026-07-19"},
    ...
    {"模型": "Claude Fable 5", "厂商": "Anthropic", "AA Intelligence Index": 60, "SciCode 编程能力 (%)": 0, "GDPval-AA v2 Elo": 1818, "Output Speed (t/s)": 0, "Cost per Task (USD)": 2.75, "来源": "Artificial Analysis（Intel=60 全球第1；Elo=1818；Cost=$2.75；Speed AA 未提供）", "更新时间": "2026-07-19"},
