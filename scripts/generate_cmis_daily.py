...
DOMESTIC_RENTAL_INPUT = {
    ...
    "昇腾 910B": {
        "original": "SMM 样本：910B2 月租约 1.2-1.5 万元；极智算 8×910B 裸金属 15,600-17,040 元/月；云擎天下 8×910B 裸金属 15,000 元/月",
        "monthly_wan": 1.35,
        "price_basis": "低置信观察",
        "price_band": "1.2-1.5（SMM）；1.5-1.7（极智算/云擎天下）",
        "price_refresh_rule": "每日优先检索 SMM、极智算 jygpu.com、云擎天下 omniyq.com、运营商、IDC、集成商和国产智算中心明确 8卡整机月租；若出现更高置信公开价，替换当前 SMM 区间中位数；否则沿用低置信观察价并保持 REVIEW。",
        "source": "SMM 算力直播 + 极智算/云擎天下 910B 裸金属价（多源交叉验证）",
        "confidence": 75,
        "consensus": "Medium",
        "historical": "HIST_INSUFFICIENT",
        "status": "REVIEW",
        "note": "910B 子型号、形态和异地部署限制未拆清；极智算和云擎天下已验证有 910B 8卡裸金属价（1.5-1.7 万/月），与 SMM 区间 1.2-1.5 万/月部分重叠。因属于国产战略关注卡，按 SMM 区间中点进入国内指数展示，但需继续扩源确认子型号差异，不进入 ROI。",
    },
    "寒武纪 MLU370-X8": {
        "original": "天翼云 PCH1 寒武纪云主机最大公开规格 pch1.21xlarge.3：84 vCPU / 252GB / 4×MLU370-S4 / 包月 24964.07 元；折算 8 卡云实例等效价=24964.07×2×0.85≈4.24 万元/月（国产计算加速型云主机 1-3 年 8.5 折）。另按国产8卡整机供给、云价溢价和可比租赁模型给出裸机市场核价区间 2.8-3.8 万元/月，仅作估算。极智算、云擎天下公开页面未找到寒武纪 MLU 租赁价。",
        "monthly_wan": 4.24,
        "price_basis": "云价折算",
        "price_band": "云价折算 4.24；裸机市场核价 2.8-3.8",
        "price_refresh_rule": "每日优先检索寒武纪 MLU 8卡整机/裸机长租公开价（SMM、曙光智算 scnet.cn、天翼云、运营商、IDC）；若找到明确市场价，用公开市场价替代云价折算；若未找到，继续使用天翼云 4卡云实例折算价，并保留裸机市场核价区间作参考。关键词：寒武纪 MLU590 月租、MLU370-X8 租赁。",
        "source": "天翼云 PCH1：4×MLU370-S4 云主机包月价折算为 8卡云实例等效价（非8卡整机长租成交价）",
        "confidence": 62,
        "consensus": "Low",
        "historical": "HIST_INSUFFICIENT",
        "status": "REVIEW",
        "note": "寒武纪 MLU 属于国产战略关注卡；当前入图价格基于天翼云明确 4卡云主机配置与包月价折算到 8卡云实例等效价，不是8卡整机长租成交价。裸机市场核价区间 2.8-3.8 万元/月仅用于价格带判断。极智算、云擎天下公开页面未找到寒武纪 MLU 租赁价；需继续扩源至曙光智算、SMM 算力快讯。不进入 ROI。",
    },
    "海光 DCU K100": {
        "original": "已确认金品 KG4208-H73 为海光 7300 双路 4U 8卡国产化 GPU 服务器，支持 8×全高全长双宽 GPU 卡。未取得公开成交月租价；按已确认 8卡服务器形态、国产智算供给线索、H100 8卡租赁研报锚点和可比国产裸机租赁带，市场核价区间估为 3.5-4.5 万元/月，中位数 4.0 万元入图。极智算、云擎天下公开页面未找到海光 DCU 租赁价。",
        "monthly_wan": 4.0,
        "price_basis": "市场核价区间（估算）",
        "price_band": "3.5-4.5",
        "price_refresh_rule": "每日优先检索海光 DCU 8卡整机、裸机、智算中心或集成商明确月租（SMM、曙光智算 scnet.cn、天翼云、运营商、IDC、淘宝/闲鱼）；若找到公开市场价，按来源置信度更新价格口径和标准化价格；若未找到，沿用 3.5-4.5 万元/月市场核价区间，中位数入图。关键词：海光 DCU Z100 租赁、DCU K100 月租。",
        "source": "金品 KG4208-H73 海光双路8卡服务器配置确认；行业租赁模型与国产裸机可比区间核价（非公开成交价）",
        "confidence": 48,
        "consensus": "Low",
        "historical": "HIST_INSUFFICIENT",
        "status": "REVIEW",
        "note": "海光 DCU 属于国产战略关注卡；已确认 8卡服务器架构，但未取得公开成交月租。极智算、云擎天下公开页面未找到海光 DCU 租赁价。本期按 8卡形态、行业按台/月计租模型和可比国产供给做市场核价区间；需继续寻找 SMM、曙光智算、运营商或集成商公开报价复核。不进入 ROI。",
    },
    "壁仞 BR100": {
        "original": "已确认壁仞 BR100/BR104 具备 OAM/PCIe 板卡形态，8个 OAM 模组可置于 UBB 形成单节点8卡全互联；海玄 OAM 服务器为 8PFLOPS / 512GB HBM2e / 最大功耗 7kW。未取得公开成交月租价；按 8卡 OAM 整机形态、H100 8卡租赁研报锚点和国产高端训练卡折价，市场核价区间估为 3.8-4.8 万元/月，中位数 4.3 万元入图。极智算、云擎天下公开页面未找到壁仞 BR100 租赁价。",
        "monthly_wan": 4.3,
        "price_basis": "市场核价区间（估算）",
        "price_band": "3.8-4.8",
        "price_refresh_rule": "每日优先检索壁仞 BR100/BR104/BR106 8卡 OAM 整机、裸机或智算中心明确月租（SMM、曙光智算 scnet.cn、运营商、IDC、淘宝/闲鱼）；若找到公开市场价，替换估算区间中位数；若未找到，沿用 3.8-4.8 万元/月市场核价区间，中位数入图。关键词：壁仞 BR100 月租、BR106M 租赁。",
        "source": "壁仞 BR100/BR104 8卡 OAM 服务器形态确认；行业租赁模型与国产高端训练卡可比区间核价（非公开成交价）",
        "confidence": 48,
        "consensus": "Low",
        "historical": "HIST_INSUFFICIENT",
        "status": "REVIEW",
        "note": "壁仞 BR100 属于国产战略关注卡；已补充 BR100/BR104 8卡 OAM 服务器形态依据，但未取得公开成交月租。极智算、云擎天下公开页面未找到壁仞 BR100 租赁价。本期按市场核价区间展示，不使用未确认卡数/型号的套餐价，不进入 ROI。",
    },
    "摩尔线程 MTT S4000": {
        "original": "UCache 公开页确认摩尔线程 S4000 8卡训推一体机可租赁；摩尔线程官方 S4000 支持单机8卡和多机多卡，Gitee AI 文档显示 MTT S5000 面向大模型训练推理，80GB 显存、Dense 1000 TFlops、MTLink 8卡全连接拓扑。未取得公开成交月租价；按已确认 8卡供给、S5000 规格提升和国产租赁可比带，市场核价区间估为 3.0-4.0 万元/月，中位数 3.5 万元入图。极智算、云擎天下公开页面未找到摩尔线程 S4000 租赁价。",
        "monthly_wan": 3.5,
        "price_basis": "市场核价区间（估算）",
        "price_band": "3.0-4.0",
        "price_refresh_rule": "每日优先检索摩尔线程 S4000/S5000 8卡训推一体机、裸机或智算中心明确月租（SMM、AutoDL、胜算云、模力方舟、运营商、IDC、淘宝/闲鱼）；若找到公开市场价，替换估算区间中位数；若未找到，沿用 3.0-4.0 万元/月市场核价区间，中位数入图。关键词：摩尔线程 S4000 租赁、MTT S5000 月租。",
        "source": "UCache S4000 8卡训推一体机租赁供给、摩尔线程 S4000 官方单机8卡能力、Gitee AI S5000 8卡互联规格；市场核价区间（非公开成交价）",
        "confidence": 50,
        "consensus": "Low",
        "historical": "HIST_INSUFFICIENT",
        "status": "REVIEW",
        "note": "摩尔线程 MTT S4000 属于国产战略关注卡；已确认 8卡 S4000 租赁供给、官方单机8卡能力，并补充 S5000 8卡互联规格。极智算、云擎天下公开页面未找到摩尔线程 S4000 租赁价。本期按市场核价区间展示，不把小模型项目费用或单卡价折成整机月租，不进入 ROI。",
    },
}
