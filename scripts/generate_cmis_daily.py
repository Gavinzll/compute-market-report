...
<body>
  <main class="page">
    ...
    <section id="domestic">
      ...
      {table(domestic_index_rows, ["GPU 型号", "GPU 分类", "价格口径", "标准化价格", "国内月租/海外月租", "Confidence Score", "校验状态", "口径说明"] if domestic_index_rows else None)}
    </section>
    ...
    <section id="overseas">
      ...
      {table(overseas_pass, ["GPU 型号", "主数据源", "原始价格", "标准化价格", "单卡小时价（人民币）", "Confidence Score", "校验状态"] if overseas_pass else None)}
    </section>
